  ...
  function node_modulesFirebaseAuthDistAuthEsmJs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      ...
      */
      ...
      function za(a) {
        for (var b in ya) if (ya[b].id === a) return a = ya[b], {
      ...
      function Dc(a) {
        return new D(function (b, c) {
          ...
          if (d) for (var f = function f(p, v) {
            ...
            c(p);
          }, h = 0, m; h < a.length; h++) m = a[h], Bc(m, sa(f, h), g);else b(e);
        });
      }
      ...
      function Ec(a) {
        return new D(function (b) {
          ...
          if (c) for (var e = function e(h, m, p) {
            ...
            0 == c && b(d);
          }, f = 0, g; f < a.length; f++) g = a[f], Bc(g, sa(e, f, !0), sa(e, f, !1));else b(d);
        });
      }
      ...
      k.ec = function () {
        for (var a; a = Ic(this);) Jc(this, a, this.a, this.i);

        this.h = !1;
      };

      function Jc(a, b, c, d) {
        if (c == xc && b.b && !b.c) for (; a && a.g; a = a.c) a.g = !1;
      ...
      function jd(a, b, c, d, e) {
        if (d && d.once) kd(a, b, c, d, e);else if (Array.isArray(b)) for (var f = 0; f < b.length; f++) jd(a, b[f], c, d, e);else c = ld(c), a && a[$c] ? md(a, b, c, q(d) ? !!d.capture : !!d, e) : nd(a, b, c, !1, d, e);
      }
      ...
      function kd(a, b, c, d, e) {
        if (Array.isArray(b)) for (var f = 0; f < b.length; f++) kd(a, b[f], c, d, e);else c = ld(c), a && a[$c] ? sd(a, b, c, q(d) ? !!d.capture : !!d, e) : nd(a, b, c, !0, d, e);
      }

      function td(a, b, c, d, e) {
        if (Array.isArray(b)) for (var f = 0; f < b.length; f++) td(a, b[f], c, d, e);else (d = q(d) ? !!d.capture : !!d, c = ld(c), a && a[$c]) ? (a = a.u, b = String(b).toString(), b in a.a && (f = a.a[b], c = ed(f, c, d, e), -1 < c && (cd(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.a[b], a.b--)))) : a && (a = od(a)) && (b = a.a[b.toString()], a = -1, b && (a = ed(b, c, d, e)), (c = -1 < a ? b[a] : null) && vd(c));
      }
      ...
      function Ed(a, b) {
        if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);else if (ma(a) || "string" === typeof a) x(a, b, void 0);else for (var c = Dd(a), d = Cd(a), e = d.length, f = 0; f < e; f++) b.call(void 0, d[f], c && c[f], a);
      }
      ...
      */
      ...
      Gh.prototype.log = function (a, b, c) {
        if (a.value >= Mh(this).value) for (n(b) && (b = b()), a = new Eh(a, String(b), this.f), c && (a.a = c), c = this; c;) c = c.a;
      };
      ...
      */
      ...
      function Ri(a, b) {
        ...
        for (var e in d) if (0 === c.indexOf(e)) return new u(d[e], b);
